 ...
 */
export function shouldUseOtel(config) {
 ...
 */
export function resolveEndpointForContainer(endpoint, runtime) {
...
export function generateOtelConfig(config) {
    const otelConfig = buildOtelConfig(config);
    return renderOtelConfigYaml(otelConfig);
}
export function generateOtelConfigObject(config) {
    return buildOtelConfig(config);
}
function buildOtelConfig(config) {
...
function renderOtelConfigYaml(value, indent = 0) {
