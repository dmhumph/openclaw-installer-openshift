...
export function buildSoulMd(config) {
    const displayName = config.agentDisplayName || config.agentName;
...
export function buildIdentityMd(config) {
    const id = agentId(config);
    const displayName = config.agentDisplayName || config.agentName;
...
export function buildToolsMd(config) {
    const id = agentId(config);
...
export function buildUserMd(config) {
...
export function buildHeartbeatMd() {
 ...
 */
export function loadWorkspaceFiles(config, log) {
    const id = agentId(config);
